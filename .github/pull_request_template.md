...
- [ ] Follows the patterns in [ARCHITECTURE.md](https://github.com/TaterTotterson/240-MP-Emby-Jelly/blob/main/ARCHITECTURE.md) and the principles in [CONTRIBUTING.md](https://github.com/TaterTotterson/240-MP-Emby-Jelly/blob/main/CONTRIBUTING.md)
